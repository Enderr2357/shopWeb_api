package com.pratice.shopwebapi.common.utils;
...
public class MybatisGen {
    ...
    public static void main(String[] args) {
        String path = System.getProperty("user.dir").concat(File.separator).concat("src").concat(File.separator).concat("main")
                .concat(File.separator).concat("java").concat(File.separator).concat("com").concat(File.separator).concat("pratice").concat(File.separator).concat("shopwebapi").concat(File.separator);
        ...
        FastAutoGenerator.create("jdbc:mysql://180.107.109.180:3306/shopping", "root", "wwasd123")
